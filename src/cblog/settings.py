...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/nawal/capstone/username", WithDecryption=False)
    password_param = ssm.get_parameter(Name="/nawal/capstone/password", WithDecryption=False)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'blog-app-db.cr0y2e2mw3t6.eu-central-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'sdacapstone-nawal-blog' # please enter your s3 bucket name
